					...
					<li class="sidebar-item ">
						<a href="#inputdata" data-bs-toggle="collapse" class="sidebar-link collapsed">
							...
							<ul id="inputdata" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
								...
								<li class="sidebar-item "><a class="sidebar-link" href="index.html">Hak Akses</a></li>
							</ul>
					</li>
					...
					<div class="row">
						...
						<div class="col-md-3 col-xl-2">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">Surat Pengantar</h5>
								</div>

								<div class="list-group list-group-flush" role="tablist">
									<a class="list-group-item list-group-item-action active" data-bs-toggle="list" href="#sipil" role="tab">
										Keterangan Domisili
									</a>
									<a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#ktp" role="tab">
										KTP
									</a>
									<a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#pindahpenduduk" role="tab">
										Pindah Penduduk
									</a>
						...
						<div class="col-md-9 col-xl-10">
							<div class="tab-content">
								...
								<!-- awal form input keterangan domisili -->
								<div class="tab-pane fade show active" id="sipil" role="tabpanel">

									<div class="card">
										<div class="card-header">

											<h5 class="card-title mb-0">Keterangan Domisili</h5>
										</div>
										<div class="card-body">
											...
											<form action="" method="POST">
												<div class="row">
													...
													<div class="mb-3 col-md-4">
														<input type="date" class="tm form-control" id="tgl-indo" name="tgl_lahir" placeholder="Tanggal Lahir">
													</div>
													<div class="mb-3 col-md-4">
													...
													<div class="mb-3 col-md-10">
														<textarea type="text" class="form-control" rows="2" name="alamat" placeholder="Alamat"></textarea>
													</div>
								...
								<!-- akhir form input keterangan domisili -->
